...
namespace EmployeeProject.Controllers
{
    ...
    public class AdministrationController : Controller
    {
        ...
        public async Task<IActionResult> EditRole(string id)
        {
            ...
            if (role == null)
            {
                ViewBag.ErrorMessage = $"Role Id with Id = {id} cannot be found";
        ...
        public async Task<IActionResult> EditRole(EditRoleViewModel model)
        {
            ...
            if (role == null)
            {
                ViewBag.ErrorMessage = $"Role Id with Id = {model.Id} cannot be found";
                return View("NotFound");
            }
            else
            {
        ...
        public async Task<IActionResult> EditUsersInRole(string RoleId)
        {
            ...
            if (role == null)
            {
                ViewBag.ErrorMessage = $"Role Id with Id = {RoleId} cannot be found";
                return View("NotFound");
            }
        ...
        public async Task<IActionResult> EditUser(string id)
        {
            ...
            if (user == null)
            {
                ViewBag.ErrorMessage = $"User Id with Id = {id} cannot be found";
                return View("NotFound");
            }
        ...
        public async Task<IActionResult> ManageUserClaims(UserClaimsViewModel model)
        {
            ...
            result = await userManager.AddClaimsAsync(user, 
                model.Claims.Select(y => new Claim(y.ClaimType, y.IsSelected.ToString())));
            if (!result.Succeeded)
            {
